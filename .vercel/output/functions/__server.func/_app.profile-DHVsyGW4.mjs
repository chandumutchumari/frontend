...
import { I as Calendar, R as Building2, _ as Mail, p as Phone, r as User, z as BookOpen } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app.profile-DHVsyGW4.js
...
function ProfilePage() {
	...
	formatDisplayName(data?.fatherName);
	formatDisplayName(data?.motherName);
	const initials = displayStudentName ? displayStudentName.split(" ").map((n) => n[0]).slice(0, 2).join("") : "?";
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: group.keys.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: k === "studentName" || k === "fatherName" || k === "motherName" ? formatDisplayName(data?.[k]) || "—" : data?.[k] ?? "—"
						})]
					}, k))
				})]
			}, group.title))
