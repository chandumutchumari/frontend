...
import { n as useNotifications } from "./_ssr/NotificationContext-CQdoJU0u.mjs";
import { t as cn } from "./_ssr/utils-C_uf36nf.mjs";
import { n as getProfile, t as formatDisplayName } from "./_ssr/formatter-BG-twP6X.mjs";
import { f as Outlet, g as Link, l as useRouterState } from "./_libs/@tanstack/react-router+[...].mjs";
import { t as useQuery } from "./_libs/tanstack__react-query.mjs";
import { B as BookMarked, D as ClipboardList, E as Clock, F as Check, G as PenLine, H as Award, J as House, L as CalendarDays, M as ChevronRight, N as ChevronLeft, T as FileText, V as Bell, X as FileChartColumnIncreasing, Z as CircleCheck, b as KeyRound, g as Menu, h as MessageSquare, k as Circle, m as Moon, n as X, o as Sun, r as User, u as Settings, v as LogOut, w as GraduationCap, x as Info, y as LayoutDashboard } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app-DqsFodNv.js
		...
		children: [!collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: items.map((it) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					className: cn("relative flex items-center gap-3 px-3 py-3 min-h-[44px] rounded-xl text-sm font-medium transition-all duration-200", "md:px-3 md:py-2.5 md:min-h-0", active ? "text-primary-foreground shadow-sm" : "text-muted-foreground hover:text-foreground hover:bg-muted/60", collapsed && "justify-center px-2"),
					children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-11 w-11 rounded-2xl shadow-md shrink-0 overflow-hidden bg-transparent",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: "/images/logo.png",
							alt: "campuSync logo",
							className: "h-full w-full object-cover"
						})
					}), !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-sm font-bold leading-tight tracking-tight font-sora",
...
function Topbar({ onMenu }) {
	...
	const initials = displayStudentName ? displayStudentName.split(" ").map((n) => n[0]).slice(0, 2).join("").toUpperCase() : "ST";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: "sticky top-0 z-20 h-12 md:h-16 glass-strong border-b border-border/60",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "h-full px-3 sm:px-6 flex items-center gap-3",
			children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenuLabel, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: displayStudentName || "Student"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function DashboardLayout({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen flex bg-background text-foreground gradient-mesh overflow-x-hidden",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sidebar, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Topbar, {
				...
				className: "flex-1 p-3 sm:p-6 lg:p-8 max-w-[1600px] w-full mx-auto overflow-x-hidden",
