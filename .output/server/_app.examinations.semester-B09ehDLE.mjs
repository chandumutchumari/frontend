...
import { X as ChartLine } from "./_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app.examinations.semester-B09ehDLE.js
...
function SemesterPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHeader, {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GlassCard, { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-4 pt-4 border-t border-border/60 flex justify-between text-sm",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-muted-foreground",
							children: "Total Credits"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "font-bold",
							children: data.totalCredits
						})]
					})
				] })
			]
		...
		data.currentSemesterResults?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
			...
			columns: [
				...
				},
				{
					...
					header: "Result",
					render: (r) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
						className: cn("rounded-full", r.result === "Pass" ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10" : "bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-500/10"),
						children: r.result
					})
				}
			]
